...
class Terminal(object):
    ...
    def rmdir(self, name):
        ...
        if os.path.isdir(name):
            ...
            return f"{name} is not directory or does not exist"
    ...
    def cd(self, name):
        ...
        if name == "..":
            ...
            return f"Directory {name} does not exist"
    ...
    def ls(self, path=None):
        ...
        return ' '.join(str(e) for e in os.listdir(path))
    ...
    def man(self, func_name):
        ...
        if func_name in dir(self):
            ...
            return f"{func_name} is not defined"


def get_funcs():
    return [method for method in dir(Terminal) if not method.startswith('__')]
